...
'INSTANT VB NOTE: The variable hotTrackRectangle was renamed since Visual Basic does not allow variables and other class members to have the same name:
		Private hotTrackRectangle_Renamed As Rectangle
		Private groupEdit As BaseEdit
'INSTANT VB NOTE: The variable showGroupEditorOnMouseHover was renamed since Visual Basic does not allow variables and other class members to have the same name:
		Private showGroupEditorOnMouseHover_Renamed As Boolean = False
'INSTANT VB NOTE: The variable singleClick was renamed since Visual Basic does not allow variables and other class members to have the same name:
